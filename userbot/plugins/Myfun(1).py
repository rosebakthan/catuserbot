...
SLAP_TEMPLATES = [
    " 𔒒K࿆I𝐝Ｉ𝕠⃤S𝓀α᳄☤👁‍🗨 {victim}ന്റെ തലക്ക് ഒലക്ക കൊണ്ട് അഞ്ചാറു അടി കൊടുത്തു 😪😪 .", 
    " 𔒒K࿆I𝐝Ｉ𝕠⃤S𝓀α᳄☤👁‍🗨 ചാണകം വാരി {victim}ന്റെ മോന്തക്ക് എറിഞ്ഞു 🤢🤮 .",
    "️ 𔒒K࿆I𝐝Ｉ𝕠⃤S𝓀α᳄☤👁‍🗨 ഓടി വന്ന് {victim}ന്റെ തലയിൽ ചീമുട്ടയെറിഞ്ഞു 🤭🤭😜.",
    "𔒒K࿆I𝐝Ｉ𝕠⃤S𝓀α᳄☤👁‍🗨️ {victim}നെ കാലേ വാരി നിലത്തടിച്ചു 🤓☹️",
    "𔒒K࿆I𝐝Ｉ𝕠⃤S𝓀α᳄☤👁‍🗨️ വലിയ പാറക്കല്ലെടുത്തു {victim}ന്റെ തലക്കെറിഞ്ഞു 😱😱🤭 .",
    "𔒒K࿆I𝐝Ｉ𝕠⃤S𝓀α᳄☤👁‍🗨️ {victim}നെ വിളിച്ചോണ്ട് പോയി പൊട്ടകിണറ്റിൽ തള്ളിയിട്ടു 🤗🤗😝 .", 
    "𔒒K࿆I𝐝Ｉ𝕠⃤S𝓀α᳄☤👁‍🗨️ കാക്കയെ വിളിച്ചു വരുത്തി {victim}ന്റെ തലയിൽ അപ്പിയിടീച്ചു 😝🤣 .",
    "𔒒K࿆I𝐝Ｉ𝕠⃤S𝓀α᳄☤👁‍🗨️ ഓടി വന്ന് ചൂരൽ കൊണ്ട് {victim}ന്റെ ചന്തിക്കിട്ട് അഞ്ചാറു അടി കൊടുത്ത് 😂😜 .",
    "𔒒K࿆I𝐝Ｉ𝕠⃤S𝓀α᳄☤👁‍🗨️ {victim}നെ കൊതുകിനെ കൊല്ലുന്ന പോലെ അടിച്ചു കൊന്നു 🤭😜.", 
    "𔒒K࿆I𝐝Ｉ𝕠⃤S𝓀α᳄☤👁‍🗨️ കോഴിക്കാഷ്ടം എടുത്ത് {victim}ന്റെ മുഖത്തു തേച്ചു 🤭🤣.",
    "𔒒K࿆I𝐝Ｉ𝕠⃤S𝓀α᳄☤👁‍🗨️ {victim}ne എടുത്തോണ്ട് പോയി ചാണകക്കുഴിയിലിട്ടു 🤣🤣😛.",
    "𔒒K࿆I𝐝Ｉ𝕠⃤S𝓀α᳄☤👁‍🗨️ പട്ടിയെ അഴിച്ചു വിട്ട് {victim}ന്റെ ചന്തിയിൽ കടിപ്പിച്ചു 😂😂😛.",
    "𔒒K࿆I𝐝Ｉ𝕠⃤S𝓀α᳄☤👁‍🗨️ കട്ടുറുറുമ്പിനെകൊണ്ട് {victim}ന്റെ കുണ്ടിക്ക് കടിപ്പിച്ചു 🤭🤭😜", 
    "𔒒K࿆I𝐝Ｉ𝕠⃤S𝓀α᳄☤👁‍🗨️ {victim}നെ കോഴിയാണെന്ന് കരുതി കൂട്ടിലടച്ചു 🤭🤭😜", 
]
